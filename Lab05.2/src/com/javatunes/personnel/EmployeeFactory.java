...
public class EmployeeFactory {
     ...
     */
    // Creates a reference to an abstract class
    public static Employee createEmployee(Map<String, String> inputMap) throws IllegalArgumentException {
        ...
        if (!"SE".equals(type) && !"HE".equals(type)) {
            throw new IllegalArgumentException("Invalid type: " + type + ". Must be either SE or HE.");
        }

        String name     = inputMap.get("name"); // can throw these up here to prevent redundancies below
