...
public class EmployeeFactoryTest {
    ...
    public void createEmployee_shouldReturnSalariedEmployee_whenTypeSE() {
        ...
        assertEquals(SalariedEmployee.class, emp.getClass());   // Asserting an exact class-type match; prevents ClassCastException after the downcast

        verifyNameAndHireDate(emp);

        // downcast reference 'emp' to SalariedEmployee to call getSalary() because Employee doesn't have getSalary()
    ...
    public void createEmployee_shouldReturnHourlyEmployee_whenTypeHE() {
        ...
        // downcast reference 'emp' to HourlyEmployee to call getRate(), getHours() because Employee doesn't have those getters
